...
import '../dashboard/delivery_progress_page.dart';


class PaymentViaKhalti extends StatelessWidget {
  const PaymentViaKhalti({Key? key}) : super(key: key);
            ...
            onPressed: () async {
              ...
              try {
                ...
                if (otpCode != null) {
                  ...
                  // Navigate to DeliveryProgressPage on successful payment
                  Navigator.push(
                    context,
